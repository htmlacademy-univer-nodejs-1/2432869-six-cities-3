...
import { BaseController, DocumentExistsMiddleware, HttpError, RequestBody, RequestParams, ValidateDtoMiddleware, ValidateObjectIdMiddleware } from '../../../rest/index.js';
